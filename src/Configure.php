...
class Configure
{
    ...
    {
        $left = $config->BBCodes->addCustom(
            '[ileft]{URL}[/ileft]',
            '<img src="{URL}" class="bb-img bb-img--left" loading="lazy" />'
        );
        $left->contentAttribute = 'url';

        $center = $config->BBCodes->addCustom(
            '[icenter]{URL}[/icenter]',
            '<img src="{URL}" class="bb-img bb-img--center" loading="lazy" />'
        );
        $center->contentAttribute = 'url';

        $right = $config->BBCodes->addCustom(
            '[iright]{URL}[/iright]',
            '<img src="{URL}" class="bb-img bb-img--right" loading="lazy" />'
        );
        $right->contentAttribute = 'url';
    }
